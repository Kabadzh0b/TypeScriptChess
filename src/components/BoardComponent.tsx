      ...
      <div className={chooseFigureMenu === null ? "hidden" : ""}>
        <div className={chooseFigureMenu === Colors.White ? "" : "hidden"}>
          <div
            onClick={() => {
              ...
              board.pawnEvolution(pawnEvolutionSquare!, Queen);
              setTurn(Colors.Black);
            }}
            className="chooseFigure"
          >
            <img className="square img" src={whiteQueenLogo} alt="figure" />
          </div>
          <div
            onClick={() => {
              setChooseFigureMenu(null);
              board.pawnEvolution(pawnEvolutionSquare!, Rook);
              setTurn(Colors.Black);
            }}
            className="chooseFigure"
          >
            <img className="square img" src={whiteRookLogo} alt="figure" />
          </div>
          <div
            onClick={() => {
              setChooseFigureMenu(null);
              board.pawnEvolution(pawnEvolutionSquare!, Bishop);
              setTurn(Colors.Black);
            }}
            className="chooseFigure"
          >
            <img className="square img" src={whiteBishopLogo} alt="figure" />
          </div>
          <div
            onClick={() => {
              setChooseFigureMenu(null);
              board.pawnEvolution(pawnEvolutionSquare!, Knight);
              setTurn(Colors.Black);
            }}
            className="chooseFigure"
          >
        ...
        <div className={chooseFigureMenu === Colors.Black ? "" : "hidden"}>
          <div
            ...
            className="chooseFigure"
          >
            <img className="square img" src={blackQueenLogo} alt="figure" />
          </div>
          <div
            onClick={() => {
              setChooseFigureMenu(null);
            ...
            className="chooseFigure"
          >
            <img className="square img" src={blackRookLogo} alt="figure" />
          </div>
          <div
            onClick={() => {
              setChooseFigureMenu(null);
            ...
            className="chooseFigure"
          >
            <img className="square img" src={blackBishopLogo} alt="figure" />
          </div>
          <div
            onClick={() => {
              setChooseFigureMenu(null);
            ...
            className="chooseFigure"
          >
            <img className="square img" src={blackKnightLogo} alt="figure" />
          </div>
        </div>
      </div>
    </div>
